...
// 3) Deve-se redirecionar  para uma nova página em que haverá um mensagem de "Bem-vind@ Fulano" e um botao de sair.

// 4) Sempre que a página for recarregada (onload), deve-se validar a informação do usuário (verificar se existe um usuário na sessão).
